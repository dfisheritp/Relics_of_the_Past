...
public class Problem443 
{
    public int compress(char[] chars)
    {
        ...
        while (readIdx < chars.length)
        {
            ...
            while (readIdx + groupLength < chars.length   
                    // matching groups                  
                    && chars[readIdx + groupLength] == chars[readIdx])      
            {
                groupLength++;
            }
            chars[modifyIdx] = chars[readIdx];
            modifyIdx++;
            if (groupLength > 1)
            {
                // beyond silly
        ...
        // This is the length of the new compacted "String".
        return modifyIdx;   
    }
}
